...
{
    [TestFixture] 
    public class NegativeTestCaseGeneratorTest
    {
     ...
     public void Generate()
      {
          eq22.CurrentState = State.NEGATIVE;
          combi2.CurrentState = State.NEGATIVE;
          List <Dependency> deps = new List<Dependency>();
          CompoundEdit ce = new CompoundEdit();
          deps.Add(dep);
          NegativeTestCasesGenerator generator = new NegativeTestCasesGenerator(deps, structure, 10000);
